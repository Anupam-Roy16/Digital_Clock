...
class MA(App):
        ...
        for r in buttons:
            ...
            for label in r:
                button=Button(
                    ...
                    pos_hint={"center_x":0.5,"centre_y":.5},
                )
    ...
    def on_button_press(self,instance):
        ...
        if button_text=='c':
            ...
            if current and (
                self.last_was_operator and button_text in self.op):
                return
            elif current=="" and button_text in self.op:
                return
            else:
                new_text=current+button_text
                self.solution.text=new_text
        self.last_button=button_text
        self.last_was_operator=self.last_button in self.op
